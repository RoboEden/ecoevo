...
class WebApp:
    ...
    def register_output_callbacks(self):
        ...
        @self.app.callback(
            ...
            Input('next-actions', 'data'),
        )
        def _callback_control_display(
            selectedData,
            write_n_clicks,
            clear_n_clicks,
            ...
            if _data is not None:
                ...
                if write_n_clicks:  # 0 or 1
                    ...
                    action_to_write = ((primary_action, secondary_action),
                                       None, None)
                    for id in ids:
        ...
        def _callback_info_panel(clickData, step_n_clicks, reset_n_clicks):
            # update clickData
            if reset_n_clicks:
    ...
    def register_input_callbacks(self):
        ...
        def _callback_game_screen(step_n_clicks, reset_n_clicks):
